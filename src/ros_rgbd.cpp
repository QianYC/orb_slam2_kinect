...
#include"orb_slam2_kinetic/System.h"
...
//    message_filters::Subscriber<sensor_msgs::Image> ir_sub(nh, "/kinect2/sd/image_ir", 1);
...
//    message_filters::Synchronizer <sync_pol> sync(sync_pol(10), rgb_sub, depth_sub, ir_sub);
...
//void ImageGrabber::GrabRGBD(const sensor_msgs::ImageConstPtr& msgRGB,const sensor_msgs::ImageConstPtr& msgD,const sensor_msgs::ImageConstPtr& msgI)
...
//    try {
//        cv_ptrI = cv_bridge::toCvShare(msgI);
//    } catch (cv_bridge::Exception &e) {
//
//        ROS_ERROR("cv_bridge exception: %s", e.what());
//        return;
